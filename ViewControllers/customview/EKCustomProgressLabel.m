...
@interface EKCustomProgressLabel ()
...
@implementation EKCustomProgressLabel
...
- (id)initWithFrame:(CGRect)frame andTheme:(EKCustomProgressTheme *)theme
{
    ...
    if (self) {
		...
		// in the label drawing over the EKCustomProgressView.
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
	if ([keyPath isEqualToString:keyThickness]) {
		EKCustomProgressView *view = (EKCustomProgressView *)object;
