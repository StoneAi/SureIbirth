...
//        
//        
//        FirstView * firstview = [[FirstView alloc]initWithFrame:CGRectMake(110, 320, 2*_firstsize, 2*_firstsize) color:1 size:_firstsize state:1];
//        firstview.backgroundColor = [UIColor clearColor];
//        [self addSubview:firstview];
//        NSLog(@"画图1啊");
...
//    {
//        FirstView * firstview = [[FirstView alloc]initWithFrame:CGRectMake(160, 320, 40, 40) color:1 size:_firstsize state:1];
//                    firstview.backgroundColor = [UIColor clearColor];
//                    [self addSubview:firstview];
//                   _firstview = firstview;
//   
//    }
//
//    else if(_firstsize ==0&_sedsize == 0&&_thirdsize==0)
//    {
//        FirstView * firstview = [[FirstView alloc]initWithFrame:CGRectMake(110, 320, 2*100, 2*100) color:1 size:100 state:0];
//        firstview.backgroundColor = [UIColor clearColor];
//        [self addSubview:firstview];
...
//    if (_sedsize!=0) {
//        if (_sedsize<20) {
//            FirstView * sedview = [[FirstView alloc]initWithFrame:CGRectMake(20, 130, 40, 40) color:2 size:_sedsize state:1];
//            sedview.backgroundColor = [UIColor clearColor];
//            [self addSubview:sedview];
//            _sedview = sedview;
////
...
//        else 
//        {
//            FirstView * sedview = [[FirstView alloc]initWithFrame:CGRectMake(20, 130, 2*_sedsize, 2*_sedsize) color:2 size:_sedsize state:1];
//            sedview.backgroundColor = [UIColor clearColor];
//            [self addSubview:sedview];
//           
//            _sedview = sedview;
//        }
////        else{
////        FirstView * sedview = [[FirstView alloc]initWithFrame:CGRectMake(20, 130, 4*_sedsize, 4*_sedsize) color:2 size:2*_sedsize state:1];
////        sedview.backgroundColor = [UIColor clearColor];
////        [self addSubview:sedview];
////        _sedview = sedview;
////        }
...
//    else if(_sedsize==0)
//    {
//        FirstView * sedview = [[FirstView alloc]initWithFrame:CGRectMake(20, 130, 2*1, 2*1) color:2 size:1 state:1];
//        sedview.backgroundColor = [UIColor clearColor];
//        [self addSubview:sedview];
//        _sedview = sedview;
//        sedview.hidden=YES;
...
//    if (_thirdsize!=0) {
//        if (_thirdsize<20) {
//            FirstView *thirdview = [[FirstView alloc]initWithFrame:CGRectMake(20, 470, 4*10,4*10) color:3 size:_thirdsize state:1];
//            thirdview.backgroundColor = [UIColor clearColor];
//            [self addSubview:thirdview];
//            _thirdview = thirdview;
//        }
//        else 
//        {
//            FirstView * thirdview = [[FirstView alloc]initWithFrame:CGRectMake(20, 470, 2*_thirdsize, 2*_thirdsize) color:3 size:_thirdsize state:1];
//            thirdview.backgroundColor = [UIColor clearColor];
//            [self addSubview:thirdview];
//            
//            _thirdview = thirdview;
...
//    else
//    {
//        FirstView *thirdview = [[FirstView alloc]initWithFrame:CGRectMake(20, 470, 2*1,2*1) color:3 size:1 state:1];
//        thirdview.backgroundColor = [UIColor clearColor];
//        [self addSubview:thirdview];
//        _thirdview = thirdview;
...
//    if (_fourthsize!=0) {
//        if (_fourthsize<20) {
//            FirstView *fourthview = [[FirstView alloc]initWithFrame:CGRectMake(180, 120, 4*10, 4*10) color:4 size:_fourthsize state:1];
//            fourthview.backgroundColor = [UIColor clearColor];
//            [self addSubview:fourthview];
//            _fourthview = fourthview;
//
//        }
//        else{
//        FirstView *fourthview = [[FirstView alloc]initWithFrame:CGRectMake(180, 120, 2*_fourthsize, 2*_fourthsize) color:4 size:_fourthsize state:1];
//        fourthview.backgroundColor = [UIColor clearColor];
//        [self addSubview:fourthview];
//        _fourthview = fourthview;
//        }
...
//    else
//    {
//        FirstView *fourthview = [[FirstView alloc]initWithFrame:CGRectMake(180, 120, 2*1, 2*1) color:4 size:1 state:1];
//        fourthview.backgroundColor = [UIColor clearColor];
//        [self addSubview:fourthview];
//        _fourthview = fourthview;
...
//    if (_fifthsize!=0) {
//        if (_fifthsize<20) {
//            FirstView *fifthview = [[FirstView alloc]initWithFrame:CGRectMake(240, 400, 4*10, 4*10) color:5 size:_fifthsize state:1];
//            fifthview.backgroundColor = [UIColor clearColor];
//            [self addSubview:fifthview];
//            _fifthview = fifthview;
//
//        }
//        else{
//        FirstView *fifthview = [[FirstView alloc]initWithFrame:CGRectMake(240, 400, 2*_fifthsize, 2*_fifthsize) color:5 size:_fifthsize state:1];
//        fifthview.backgroundColor = [UIColor clearColor];
//        [self addSubview:fifthview];
//        _fifthview = fifthview;
//        }
...
//    else
//    {
//        FirstView *fifthview = [[FirstView alloc]initWithFrame:CGRectMake(240, 400, 2*1, 2*1) color:5 size:1 state:1];
//        fifthview.backgroundColor = [UIColor clearColor];
//        [self addSubview:fifthview];
//        _fifthview = fifthview;
