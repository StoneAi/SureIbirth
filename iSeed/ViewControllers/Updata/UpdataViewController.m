...
//    [self.view addSubview:view1];
    ...
    AppVersion.text = [NSString stringWithFormat:@"V%@",[infoDic objectForKey:@"CFBundleShortVersionString"] ];
...
-(void)isAppUpdate:(id)sender
{
    if (!AppDelegateAccessor.isAppNeedUpdate) {
        XYAlertView *alert = [XYAlertView alertViewWithTitle:nil message:NSLocalizedStringFromTable(@"UpDate_Alret_Titil", @"MyLoaclization" , @"") buttons:[NSArray arrayWithObjects:NSLocalizedStringFromTable(@"APPSure", @"MyLoaclization" , @""),NSLocalizedStringFromTable(@"HistoryVC_Alret_CancleButton", @"MyLoaclization" , @""),  nil] afterDismiss:^(long buttonIndex) {
...
-(void)isFirmUpdate:(id)sender
{
    ...
    {
        XYAlertView *alert = [XYAlertView alertViewWithTitle:nil message:NSLocalizedStringFromTable(@"HistoryVC_ConnectBLE", @"MyLoaclization" , @"") buttons:[NSArray arrayWithObjects:NSLocalizedStringFromTable(@"APPSure", @"MyLoaclization" , @""),NSLocalizedStringFromTable(@"HistoryVC_Alret_CancleButton", @"MyLoaclization" , @""),  nil] afterDismiss:^(long buttonIndex) {
    ...
    {
        XYAlertView *alert = [XYAlertView alertViewWithTitle:nil message:NSLocalizedStringFromTable(@"InforVCAlretNet_Message", @"MyLoaclization" , @"") buttons:[NSArray arrayWithObjects:NSLocalizedStringFromTable(@"APPSure", @"MyLoaclization" , @""),NSLocalizedStringFromTable(@"HistoryVC_Alret_CancleButton", @"MyLoaclization" , @""),  nil] afterDismiss:^(long buttonIndex) {
