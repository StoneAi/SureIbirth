...
- (id)initWithFrame:(CGRect)frame
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(redrawComponent)
                                               ...
                                               object:nil];
    self.backgroundColor = [UIColor clearColor]; //大背景颜色 不能动
...
-(void)drawRect:(CGRect)rect
{
    ...
    //UIColor* backgroundLightColor = [UIColor colorWithWhite:1 alpha: 1];
...
//    UIColor* boxStroke = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.59];
     UIColor* boxStroke = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.59];
